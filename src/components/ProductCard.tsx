...
const ProductCard = ({ product, adminView = false }: { product: any, adminView?: boolean }) => {
    return (
        <Card className="flex flex-col pb-1">
            <CardHeader className="px-2 flex flex-row items-center justify-between space-x-0 pb-2">
            ...
            <CardContent className="flex flex-col flex-1 gap-10">
                <img src={product.image} alt="Product Image" className="h-full object-cover rounded-md"/>
