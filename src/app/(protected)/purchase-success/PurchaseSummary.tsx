...
import { fetchOrderStatus } from "@/lib/api/order";
		...
		<div className='min-h-screen flex flex-col items-center justify-center p-6'>
			<div className='flex flex-col items-center'>
				<Image
					...
					width={400}
					height={400}
					className='h-96 w-96 rounded-md my-5 object-cover'
				/>
				...
				<p className='text-center text-md mb-6'>
					...
					If you don't receive an email within 24 hours, please contact us with your order ID.
				</p>

				<p className='text-muted-foreground'>
					Order ID:{" "}
					<span className='font-bold text-sky-400'>{orderId}</span>
				</p>
				...
				<Card className='w-full my-5'>
					...
					<CardContent>
						...
						<div className='flex justify-between'>
							<p>Size: {sizeMap[order.size] || order.size}</p>
							<p>Quantity: 1</p>
						</div>
